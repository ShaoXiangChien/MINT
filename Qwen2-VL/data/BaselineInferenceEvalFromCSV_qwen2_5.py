"""
Baseline Inference Evaluation from NegBench CSV (Qwen2.5-VL)
=============================================================

Modified version of BaselineInferenceEvalFromCSV.py for Qwen2.5-VL model.
Reads directly from NegBench CSV format instead of requiring renamed images and category mapping.
...
def main(
	...
	"""
	print("="*80)
	print("BASELINE INFERENCE EVALUATION FROM CSV (Qwen2.5-VL)")
	print("="*80)
...
if __name__ == "__main__":
	...
	# Default output directory for Qwen2.5-VL results
	default_output_dir = "/home/sc305/VLM/Qwen2-VL/negbench_eval_results_qwen2_5"
	default_results_jsonl = os.path.join(default_output_dir, "baseline_results.jsonl")
	default_metrics_json = os.path.join(default_output_dir, "baseline_metrics.json")
	
	parser = argparse.ArgumentParser(
		description="Run baseline inference and evaluation from NegBench CSV (Qwen2.5-VL)."
	)
	parser.add_argument(
		"--model_path",
		type=str,
