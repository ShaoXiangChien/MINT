#!/usr/bin/env python3
"""
Bootstrap Reporting Utilities (MM-Patching)
...
def write_markdown_blurb(df: pd.DataFrame, out_dir: Path) -> None:
    ...
    lines = [
        "# Bootstrap CI Reporting Snippets (MM-Patching)\n",
        "\n",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Report figures and tables for bootstrap CIs (mm-patching)")
