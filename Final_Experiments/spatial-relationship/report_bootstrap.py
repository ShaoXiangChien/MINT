#!/usr/bin/env python3
"""
Bootstrap Reporting Utilities (Spatial-Relationship)
...
def write_markdown_blurb(df: pd.DataFrame, out_dir: Path) -> None:
    ...
    lines = [
        "# Bootstrap CI Reporting Snippets (Spatial-Relationship)\n",
        "\n",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Report figures and tables for bootstrap CIs (spatial-relationship)")
