...
if __name__ == "__main__":
    ...
    results_path = "/home/sc305/VLM/Final Experiments/global-img-ld/lg_results/qwen_baseline_results.json"
    ...
    print("Starting Qwen2-VL baseline experiment...")
    ...
    print(f"\n=== QWEN2-VL BASELINE EXPERIMENT RESULTS ===")
