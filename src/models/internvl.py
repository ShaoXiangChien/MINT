...
class InternVLAdapter(BaseModelAdapter):
    """Adapter for the InternVL family of models."""
    ...
    def prepare_inputs(self, prompt, image, mt):
        ...
        if image is not None:
            ...
            if IMG_CONTEXT in mt.tokenizer.get_vocab():
                pass  # token exists
    ...
    def generate_with_inputs(self, mt, inputs, max_new_tokens=20):
        """Generation path that uses raw input tensors instead of model.chat."""
        with torch.no_grad():
    ...
    def find_image_token_range(self, mt, inputs):
        ...
        IMG_CONTEXT_ID = 151859
        img_positions = torch.where(ids == IMG_CONTEXT_ID)[0]
...
# ======================================================================
# InternVL image preprocessing utilities
# ======================================================================
